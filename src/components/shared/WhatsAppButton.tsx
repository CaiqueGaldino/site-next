...
export default function WhatsAppButton() {
  ...
  return (
    <>
      {/* Main WhatsApp Button - Optimized for mobile */}
      <button
        onClick={handleWhatsAppClick}
        className={`
          group fixed bottom-6 right-4 md:bottom-8 md:right-8 z-50 
