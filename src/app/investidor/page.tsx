    ...
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`https://wa.me/5588992637523?text=${encodeURIComponent(
                  "Olá! Tenho interesse em ser um Investidor Parceiro Premium da Fitness Exclusive."
                )}`}
                target="_blank"
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          ...
          >
            <h3 className="text-4xl font-black mb-4">
              Por que escolher o modelo de Investidor Parceiro?
            </h3>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            ...
            >
              <h4 className="text-2xl font-bold mb-6 text-[#FAC934]">Investidor Parceiro ✨</h4>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
      ...
      <section className="py-20 bg-zinc-900">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <a
              href={`https://wa.me/5588992637523?text=${encodeURIComponent(
                "Olá! Gostaria de receber o prospecto completo sobre o investimento Parceiro Premium na Fitness Exclusive."
              )}`}
              target="_blank"
              rel="noopener noreferrer"
