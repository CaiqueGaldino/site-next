            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`https://wa.me/5588992637523?text=${encodeURIComponent(
                  "Olá! Tenho interesse em ser um franqueado da Fitness Exclusive."
                )}`}
                target="_blank"
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h3 className="text-4xl font-black mb-4">
              Por que ser franqueado da Fitness Exclusive?
            </h3>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <a
              href={`https://wa.me/5588992637523?text=${encodeURIComponent(
                "Olá! Gostaria de receber mais informações sobre a franquia Fitness Exclusive."
              )}`}
              target="_blank"
              rel="noopener noreferrer"
